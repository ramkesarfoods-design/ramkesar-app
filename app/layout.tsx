...
export default function RootLayout({ children }) {
  ...
  return (
    <html lang="en">
      ...
      <head>
        <title>RamKesar Foods | The Pride Of Indian Taste</title>
